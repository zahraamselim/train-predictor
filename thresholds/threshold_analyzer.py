...
class ThresholdAnalyzer:
    ...
    def _load_train_params(self):
        ...
        train_params_file = Path('outputs/results/train_params.yaml')
    ...
    def analyze(self):
        ...
        if clearance_df is None or trains_df is None or travels_df is None:
            Logger.log("Missing required data files")
            return None
        ...
        output_path = self.results_dir / 'thresholds.yaml'
        with open(output_path, 'w') as f:
            yaml.dump(thresholds, f, default_flow_style=False, sort_keys=False)
        
        Logger.log(f"Thresholds saved to {output_path}")
