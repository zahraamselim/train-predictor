...
class VehicleRerouter:
    ...
    def _is_approaching_crossing(self, route):
        """Check if vehicle route crosses the rail"""
        crossing_edges = [
            'cross_w_to_cross_e_n',
            'cross_e_to_cross_w_n',
            'cross_w_to_cross_e_s',
            'cross_e_to_cross_w_s'
        ]
